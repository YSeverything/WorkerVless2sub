...
// 设置优选地址api接口
let addressesapi = [
	'https://token.everything.dynv6.net/YSeverything/YXIP/main/yxIP?token=adminYS', //可参考内容格式 自行搭建。
	'https://raw.githubusercontent.com/ZhiXuanWang/cf-speed-dns/main/ipTop.html', //可参考内容格式 自行搭建。
